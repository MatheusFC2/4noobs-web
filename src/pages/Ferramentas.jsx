    ...
    useEffect(() => {
        axios
            ...
            .then(({ data }) => {
                ...
                setCourses(coursesByFerramentas)
            });
                ...
                <div>
                    <div>
                        <div class="p-6 h-full">
                            ...
                            <h1 class="flex font-bold text-sm justify-center items-center md:text-2xl md: md:mt-12 mb-4 dark:text-white">Pagina de Ferramentas</h1>
