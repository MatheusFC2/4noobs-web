...
import Bashlogo from '../public/assets/bashlogo.jpg';
                    ...
                    <div class="flex flex-wrap justify-evenly gap-5">
                        ...
                        {courses.slice(1, 2).map((course) => {
                            return (
                                <div class="max-w-xs bg-white rounded-lg drop-shadow-[0_5px_3px_rgba(0,0,0,0.30)] dark:bg-dark-cards">
                                    <a href="#">
                                        <img class="rounded-t-lg" src={Bashlogo} alt="" />
                                    </a>
                                    <div class="p-5">
                                        <a href="#">
                                            <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white font-header">{course.name}</h5>
                        ...
                        {courses.slice(2, 3).map((course) => {
                            return (
                                <div class="max-w-xs bg-white rounded-lg drop-shadow-[0_5px_3px_rgba(0,0,0,0.30)] dark:bg-dark-cards">
                                    <a href="#">
                                        <img class="rounded-t-lg" src={Clogo} alt="" />
                                    </a>
                                    <div class="p-5">
                                        <a href="#">
                                            <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white font-header">{course.name}</h5>
                        ...
                        {courses.slice(3, 4).map((course) => {
                            return (
                                <div class="max-w-xs bg-white rounded-lg drop-shadow-[0_5px_3px_rgba(0,0,0,0.30)] dark:bg-dark-cards">
                                    <a href="#">
                                        <img class="rounded-t-lg" src={Csharplogo} alt="" />
                                    </a>
                                    <div class="p-5">
                                        <a href="#">
                                            <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white font-header">{course.name}</h5>
