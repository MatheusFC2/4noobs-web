...
export function Ldp() {
    ...
    useEffect(() => {
        ...
        .then(({ data }) => {
            const coursesByLdp = data.courses.filter((course) => course.category === 'Linguagens de programação');
    ...
    return (
        ...
        <div className="w-full overflow-scroll p-10">
            ...
            <div>
                ...
                <h1 className="flex font-bold text-sm justify-center items-center md:text-2xl md: md:mt-12 mb-4 dark:text-white">Pagina de Linguagens de programação</h1>
